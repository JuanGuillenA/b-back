...
a persistence unit "per66PersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "per66/pom.xml":
...
artifact ("per66.war") is already built. You can build
